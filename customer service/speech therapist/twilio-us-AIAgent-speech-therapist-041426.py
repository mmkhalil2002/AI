...
# ============================================================
# AUTO-INSTALL REQUIRED PACKAGES (RUN FIRST)
# ============================================================
...
# ============================================================
# OPTIONAL: GLOBAL TIMEZONE HELPERS (RECOMMENDED)
# ============================================================
UTC = timezone.utc
LOCAL_TZ = pytz.timezone(CLINIC_TZ)


print("[READY] Environment initialized successfully.")
# ---------------- Project Structure -----------------
# speech_AI_agent/
# speech_ai_agent.py
#  generate_token.py
