...
# ----------------------------------------------------------------------
    ...
    # ===== collect_first_name (stage) =====
        ...
        # Load candidates if not yet built
        ...
        if not awaiting:
            ...
            session_data[call_sid]["skip_silence_retry"] = False  # ✅ re-enable after first turn
        ...
        # ----------------- Handle input after announcement -----------------
