...
"""
MODEL_PATH = "../../../"
#MODEL_FILENAME = "cifar-27-35-unknown30-cnn-128-256-512-1024-1744s-L5205-A9999-T8766"
#DATA_PATH = "../../../data/cifar_27_35_unknown30"
...
MODEL_FILENAME= os.path.join(MODEL_PATH,"model", "rme-27-35-unknown30-cnn-128-256-512-1024-1744s-L5205-A9999-T8766")
# ------------------------------------------------------------
# DERIVED PATH (DATASET)
# ------------------------------------------------------------
# DATA_PATH is constructed from MODEL_PATH + subdirectory
DATA_PATH = os.path.join(MODEL_PATH, "data", "RME10_27_35_unknown30")
