...
def main():
    ...
    Main program:
      1) choose CPU or GPU
      2) ask the user for input mode
      3) default mode: read images from CLASIFIER_TEST / TEST_IMAGE_DIR
      4) optional mode: start TCP server, receive image, classify it,
         and return the result to the TCP client
    """
    ...
    mode = choose_classifier_input_mode()
