...
#   Every menu motion below is now TRAINED / OPTIMIZED when selected.
#   There are no separate t/u/z training commands.
#
#   1 - Train Walk
#   2 - Train Trot / Run
#   3 - Train Sit
...
def display_angle_table_and_simulate(rows, motion_label):
    ...
    In the updated design, every normal menu motion already trains
    before the angle table is displayed.
    """
