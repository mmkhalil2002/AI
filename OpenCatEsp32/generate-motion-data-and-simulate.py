...
MOTIONS = {
    "1": {
        "name": "walk",
        "label": "Walk",
        "generator": generate_walk_table,
        "repeat_on_esp32": 3,
    },
    "2": {
        "name": "trot_run",
        "label": "Trot / Run",
        "generator": generate_trot_run_table,
        "repeat_on_esp32": 3,
    },
    "3": {
        "name": "sit",
        "label": "Sit",
        "generator": generate_sit_table,
        "repeat_on_esp32": 1,
    },
    "4": {
        "name": "stand",
        "label": "Stand",
        "generator": generate_stand_table,
        "repeat_on_esp32": 1,
    },
    "5": {
        "name": "jump",
        "label": "Jump",
        "generator": generate_jump_table,
        "repeat_on_esp32": 1,
    },
    "6": {
        "name": "turn_left",
        "label": "Turn Left",
        "generator": generate_turn_left_table,
        "repeat_on_esp32": 3,
    },
    "7": {
        "name": "turn_right",
        "label": "Turn Right",
        "generator": generate_turn_right_table,
        "repeat_on_esp32": 3,
    },
}
